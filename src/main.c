...
/*   Updated: 2022/02/18 17:21:23 by yel-mrab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc > 1)
	{
		...
		if (data.stack_a.data.lenght > 1 && ft_sorted(&data))
		{
			if (data.stack_a.data.lenght <= 10)
				basic_sort(&data);
			else if (data.stack_a.data.lenght <= 100)
				main_sort(&data, 5);
